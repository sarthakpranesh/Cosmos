...
// importing localDB;
import { getUserDataAsync, delUserDataAsync, storeUserDataAsync } from '../../utils/localDb';
                    ...
                    <View style={styles.userValueInput}>
                        ...
                        <View style={{ marginVertical: 10 }}>
                            ...
                            <TextInput
                                ...
                                style={[ styles.textInput, { backgroundColor: 'rgba(0,0,0, 0.1)' } ]}
                                editable={false}
                            />
                        </View>
                        <TouchableOpacity
